import UniversityCourseSectionRepository from "../../repositories/universities/university_course_section.repository";
...
export default class UniversityCourseSectionService {
  static async addSection(data: any) {
    ...
    return UniversityCourseSectionRepository.create(data);
  }

  static async getSectionsByCourseId(courseId: number) {
    return UniversityCourseSectionRepository.findByCourseId(courseId);
  }
  ...
  static async updateSection(id: number, data: any) {
    ...
    return UniversityCourseSectionRepository.update(id, data);
  }

  static async deleteSection(id: number) {
    return UniversityCourseSectionRepository.remove(id);
  }

  static async deleteByCourseId(courseId: number) {
    return UniversityCourseSectionRepository.removeByCourseId(courseId);
  }
}
