...
router.get("/search", UniversityCourseSpecializationController.search);
router.get("/suggestions", UniversityCourseSpecializationController.suggestions);
router.get("/spell-check", UniversityCourseSpecializationController.spellCheck); 
